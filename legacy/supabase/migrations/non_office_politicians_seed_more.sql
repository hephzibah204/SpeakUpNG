...
from (
  values
    ('Atiku Abubakar','Atiku','ADC','Presidential Aspirant','Prominent Nigerian politician and former Vice President of Nigeria.',null,'["Atiku","Atiku Abubakar","H.E. Atiku Abubakar"]'::jsonb,'{}'::jsonb,85,true),
    ...
    ('Nasir Ahmad El-Rufai','El-Rufai','ADC','National Political Figure','Prominent Nigerian politician and former Governor of Kaduna State.',null,'["Nasir El-Rufai","El Rufai","Mallam El-Rufai"]'::jsonb,'{}'::jsonb,63,true),
    ('Rotimi Chibuike Amaechi','Rotimi Amaechi','ADC','National Political Figure','Prominent Nigerian politician and former Governor of Rivers State.',null,'["Rotimi Amaechi","Chibuike Amaechi"]'::jsonb,'{}'::jsonb,62,true),
